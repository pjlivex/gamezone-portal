const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/HomePage-CggoExCH.js","assets/Layout-bfeKLfHg.js","assets/GameCard-DcG5FwQ5.js","assets/zap-DwBv7T87.js","assets/GamesPage-DvzBxSVh.js","assets/PlayPage-DF9rhIr5.js"])))=>i.map(i=>d[i]);
...
const HomePage = reactExports.lazy(() => __vitePreload(() => import("./HomePage-CggoExCH.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0));
const GamesPage = reactExports.lazy(() => __vitePreload(() => import("./GamesPage-DvzBxSVh.js"), true ? __vite__mapDeps([4,1,2]) : void 0));
const PlayPage = reactExports.lazy(() => __vitePreload(() => import("./PlayPage-DF9rhIr5.js"), true ? __vite__mapDeps([5,1,3]) : void 0));
function PageSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 py-8 space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4", children: ["s1", "s2", "s3", "s4", "s5", "s6", "s7", "s8"].map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-52 rounded-2xl" }, k)) })
  ] });
}
...
const homeRoute = createRoute({
  ...
  path: "/",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageSkeleton, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(HomePage, {}) })
});
const gamesRoute = createRoute({
  ...
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageSkeleton, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(GamesPage, {}) })
});
const playRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/play/$gameId",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageSkeleton, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(PlayPage, {}) })
});
