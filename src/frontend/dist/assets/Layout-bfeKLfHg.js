import { r as reactExports, j as jsxRuntimeExports, R as React, b as clsx, c as cn, d as useNavigate, e as useRouterState, L as Link } from "./index-DVZ7AijH.js";
...
const Gamepad2 = createLucideIcon("gamepad-2", __iconNode$5);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const GAMES = [
  {
    ...
    color: "linear-gradient(135deg, oklch(0.70 0.25 145), oklch(0.55 0.22 170))",
    emoji: "🐍",
    implemented: true
  },
  {
  ...
  },
  {
    ...
    color: "linear-gradient(135deg, oklch(0.60 0.28 255), oklch(0.50 0.24 280))",
    emoji: "🃏",
    implemented: true
  },
  {
    ...
    color: "linear-gradient(135deg, oklch(0.65 0.25 345), oklch(0.55 0.22 320))",
    emoji: "🐦",
    implemented: true
  },
  {
    ...
    color: "linear-gradient(135deg, oklch(0.68 0.22 290), oklch(0.58 0.25 310))",
    emoji: "⭕",
    implemented: true
  },
  {
  ...
  },
  {
    id: "pong",
    title: "Pong",
    description: "Classic two-player paddle game — take on the AI in this timeless arcade showdown",
    category: "Action",
    tags: ["multiplayer", "classic", "arcade"],
  ...
  },
  {
    ...
    color: "linear-gradient(135deg, oklch(0.60 0.28 205), oklch(0.55 0.25 235))",
    emoji: "🟦",
    implemented: false
  },
  {
    ...
    color: "linear-gradient(135deg, oklch(0.72 0.20 145), oklch(0.60 0.22 175))",
    emoji: "🔢",
    implemented: false
  },
  {
    ...
    color: "linear-gradient(135deg, oklch(0.62 0.24 310), oklch(0.55 0.26 280))",
    emoji: "🌀",
    implemented: false
  }
];
function getGameById(id2) {
  return GAMES.find((g) => g.id === id2);
}
function Layout({ children, onSearch, searchValue = "" }) {
  const [menuOpen, setMenuOpen] = reactExports.useState(false);
  const [localSearch, setLocalSearch] = reactExports.useState(searchValue);
  ...
  const navLinkClass = (path) => `font-display font-semibold text-sm px-4 py-2 rounded-full transition-smooth ${isActive(path) ? "bg-primary text-primary-foreground" : "text-foreground hover:bg-muted"}`;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-50 bg-card border-b border-border shadow-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 h-16 flex items-center gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Link,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-xl flex items-center justify-center bg-gradient-to-br from-primary to-accent shadow-play", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Gamepad2, { className: "w-5 h-5 text-primary-foreground" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-extrabold text-xl text-gradient-primary hidden sm:block", children: "GameZone" })
            ]
          }
        ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 max-w-xs ml-auto md:ml-4 relative", children: [
      ...
      menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:hidden border-t border-border bg-card px-4 py-3 flex gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Link,
          {
            to: "/",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-card border-t border-border mt-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 py-8 flex flex-col sm:flex-row items-center justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-lg flex items-center justify-center bg-gradient-to-br from-primary to-accent", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Gamepad2, { className: "w-4 h-4 text-primary-foreground" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-foreground", children: "GameZone" })
      ] }),
...
export {
  ...
  PresenceContext as d,
  usePresence as e,
  useIsomorphicLayoutEffect as f,
  LayoutGroupContext as g,
  Slot as h,
  isHTMLElement as i,
  cva as j,
  getGameById as k,
